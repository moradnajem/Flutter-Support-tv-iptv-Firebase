  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalization.of(context)!.trans("My Order"), style: TextStyle(color: Theme.of(context).primaryColor),),
        centerTitle: true,
      ...
      body: StreamBuilder<List<SubscriptionOrderModel>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return orders!.isEmpty ? Center(child: Text(
                    AppLocalization.of(context)!.trans("You have no requests"),
                    style: TextStyle(fontSize: 18, color: Theme
                        .of(context)
                        .primaryColor)),) : ListView.builder(
  ...
  Widget _item(context, { required SubscriptionOrderModel order }) {
    ...
    switch (order.status) {
      ...
      case Status.canceled:
        ...
        statusIcon =
        const Icon(Icons.cancel, size: 22, color: Colors.orangeAccent,);
        break;
    }
                  ...
                  child: Column(
                      children: [
                        ...
                        FutureBuilder<UserModel>(
                            future:
                            FirebaseManager.shared.getUserByUid(
                                uid: order.ownerId),
                            builder: (context, snapshot) {
                              return Column(
                                children: [
