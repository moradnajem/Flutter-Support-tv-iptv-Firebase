...
class _laddchannelState extends State<laddchannel> {
  ...
  _submitData() async {
    ...
    FirebaseManager.shared.addOrEditChanne(context,  sectionuid: _activeDropDownItem!,section: section, titleAR: titleAR, titleEN: titleEN, streamURL: streamURL!,         scaffoldKey: _scaffoldKey,
    );
